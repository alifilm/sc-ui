<template>
  <div :class="[
    ...
    inputSize ? 'sc-input--' + inputSize : '',
    {
      ...
      'sc-input--suffix': $slots.suffix || suffixIcon || clearable
    }
    ]"
    ...
    <template v-if="type !== 'textarea'">
      ...
      <span
        ...
        <span class="sc-input__suffix-inner">
          ...
          <i v-else
            class="sc-input__icon sc-icon-circle-close sc-input__clear"
            @click="clear"
          ></i>
        </span>
        <i class="sc-input__icon"
          v-if="validateState"
          :class="['sc-input__validateIcon', validateIcon]">
        </i>
      </span>
      <!-- 后置元素 -->
